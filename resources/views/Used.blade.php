...
<div class="container" >
  <div class="ticket-wrapper" >
    <div class="ticket-header">
      ...
      <span class="badge"><i class="fas fa-times"></i> Deja Utiliser</span>
    </div>
      ...
      <div class="row">
        <div class="col text-center">
          ...
          <div class="profile-pic">
            <img src="assets/meen.png" alt="USM Logo" class="team-logo" style="width: 116%; margin-left: -10px;">

          </div>
          <h5 style="color: #fff; margin-top: 40px;">Omar Belli</h5>
          <button class="btn btn-view-profile">View Profile</button>
        </div>
      </div>
      <br>

      <div class="row mt-3 match-box d-flex justify-content-center">
        <div class="col text-right d-flex justify-content-end align-items-center">
          <img src="assets/téléchargement__2_-removebg-preview.png" alt="USM Logo" class="team-logo" style="width: 40%;">
            <span class="h4">USM</span>
        </div>
        <div class="col-4 d-flex justify-content-center align-items-center">
          <div class="score">
            <img src= "assets/ballon-removebg-preview.png" alt="USM Logo" class="team-logo" style="width: 69%; margin-left: 10px;">

          </div>
        </div>
        <div class="col text-left d-flex justify-content-start align-items-center">
          <img src="assets/téléchargement__1_-removebg-preview.png" alt="EST Logo" class="team-logo" style="width: 40%;">
         <span class="h4">EST</span>
        </div>
      </div>
      
      <br>
      
      <!-- Inserted location icon and text "rades" -->
      <div class="d-flex justify-content-center datetime-info">
        <i class="fas fa-map-marker-alt" style="color: #fff;"></i> <!-- FontAwesome location icon -->
        <p class="m-2" style="color: #fff; "> rades</p> <!-- Your text -->
        <i class="fas fa-door-closed" style="color: #fff;margin-left: 40px;"></i> <!-- FontAwesome location icon -->
        <p class="m-2" style="color: #fff;"> Gradin</p> <!-- Your text -->
      </div>
      <br>

      <div class="d-flex justify-content-center datetime-info" >
        <p class="m-2" style="color: #fff;">14/02/2024</p>
        <p class="m-2" style="color: #fff;">15:55:06 H</p>
      </div>

    </div>
    <div class="ticket-footer text-center mt-3">
      <p style="color: #fff;">Valid</p>
